...
columns2 = ['LIM_BAL_1', 'LIM_BAL_2', 'LIM_BAL_3',
       ...
       'PAY_AMT5_2', 'PAY_AMT5_3', 'PAY_AMT6_1', 'PAY_AMT6_2', 'PAY_AMT6_3','default payment next month']
...
while stop:
    ...
    for i in columns:
        ...
        try:
            ...
            train = base_treino.drop(i,axis=1)
            test = base_teste.drop(i,axis=1)
